...
@section('tituloPagina')
    @include('utlisComponents.btnBack',['url' => route('abonos.index')])
    Nuevo Abono
@endsection
@section('content')
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="form-control bg-secondary-light" id="nombreCliente">-</span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="form-control bg-secondary-light" id="apellidoCliente">-</span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="form-control bg-secondary-light" id="cedulaCliente">-</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <span class="form-control bg-secondary-light" id="direccionCliente">-</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="form-control bg-secondary-light" id="telefonoCliente">-</span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="form-control bg-secondary-light" id="celularCliente">-</span>
                    </div>
                </div>
    ...
    <br>
    @include('abonos.modals.modalAbono')
@endsection
@section('script')
    <script>
        ...
        {
            document.getElementById('divClientesModal').innerHTML = ""
            let url = '{{route('abonos.getListClientes')}}'+'?page='+page+'&buscar='+buscar
        ...
        const handleClickCliente = async (event)=>{
            ...
            let {data} = await axios.post('{{route('abonos.getInfoCliente')}}',
                {
        ...
        $("#selectPrestamos").on('change', async function (event) {
            document.getElementById('tblCuotas').innerHTML = "<div class='spinner-border text-primary text-center role='status'><span class='visually-hidden'>Loading...</span></div>"
            let {data} = await axios.post('{{route('abonos.getCuotasPrestamo')}}',
                {
                    'prestamoId': $(this).val()
                }
            )
        ...
        const handleChangeEventDelegation = async (event)=>{
            ...
            if(element.id==="btnAbonarCuota"){
                ...
                if (checkboxes.length > 0) {
                    ...
                    limpiarModalAbono()
                    let {data} = await axios.post('{{route('abonos.getDetalleCuota')}}',{
