<div class="modal fade" id="modalAbono" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            {{html()->form('POST',route('abonos.store'))->id('frmAbono')->open()}}
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group text-center col-md-6">
                        ...
                        <input type="text" class="form-control text-center" style="background: lightgray" readonly id="dtFechaCuota">
                    </div>
                ...
                <div class="form-control text-center">
                    <div class="row">
                        <div class="col-md-12">
                            <label class="fw-bold">Forma de Pago:</label><br>
                            <p>Seleccione los métodos de pago del cliente</p>
                        </div>
                    </div>
                    <br>
...
{{--                        </div>--}}
                    ...
                    <br>
                    <div class="col-md-12">
                        <label style="color: blue">La suma de los montos debe coincidir con el total a pagar</label><br>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-4 text-center">
                            <input class="form-control" placeholder="Monto Efectivo" data-name="rbEfectivo" id="efectivoMonto" name="efectivoMonto" type="number" disabled min="1">
                        </div>

{{--                        <div class="col-12 col-sm-3 text-center">--}}
{{--                            <input class="form-control" placeholder="Monto Tarjeta" data-name="rbTarjeta" id="tarjetaMonto" name="tarjetaMonto" type="number" disabled min="1">--}}
{{--                        </div>--}}

{{--                        <div class="col-12 col-sm-3 text-center">--}}
{{--                            <input class="form-control" placeholder="Monto Transferencia" data-name="rbTransferencia" id="transferenciaMonto" name="transferenciaMonto" type="number" disabled min="1">--}}
{{--                        </div>--}}

{{--                        <div class="col-12 col-sm-3 text-center">--}}
{{--                            <input class="form-control" placeholder="Monto Cheque" data-name="rbCheque" id="chequeMonto" name="chequeMonto" type="number" disabled min="1">--}}
{{--                        </div>--}}
                    </div>
                </div>
                <br>
                <div class="row justify-content-center">
                    <div class="col-md-6 d-flex flex-column align-items-center">
                        <div class="form-group text-center">
                            ...
                            {{html()->select('tipo_abono',['0'=>'Abono Ordinario','1'=>'Deducciones','2'=>'Dispensas de Saldo'])->class('form-control text-center')}}
                        </div>
                    </div>
                </div>
                <br>
