...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 text-end">
            @can('Reimprimir Recibos')
            <a href="{{route('abonos.printRecibo',[$abono->id_enc,'reimpresion'=>true])}}" target="_blank" class="btn btn-sm btn-warning">Reimprimir <i class="fa fa-print"></i></a>
            @endcan
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for=""><b>Tipo Abono:</b></label>
                <input type="text" class="form-control" disabled value="{{$abono->tipo}}">
            </div>
        </div>
            ...
            <table class="table table-sm">
                ...
                @foreach($abono->abono_detalle as $detalle)
                    <tr>
                        ...
                        <td>{{$detalle->prestamo_cuota->prestamo->moneda." ". $detalle->prestamo_cuota->monto_cuota}}</td>
