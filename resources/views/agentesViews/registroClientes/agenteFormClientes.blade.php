...
{{--                </li>--}}
{{--            <li class="nav-item" role="presentation">--}}
{{--                <button class="nav-link" id="prestamos-tab" data-bs-toggle="tab" data-bs-target="#prestamo" type="button" role="tab" aria-controls="prestamos" aria-selected="false">Histórico Desembolsos</button>--}}
{{--            </li>--}}
{{--            @endif--}}
        </ul>
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="datos" role="tabpanel" aria-labelledby="datos-tab">
               @include('agentesViews.registroClientes.agenteTabDatosGenerales')
            </div>
{{--            @if(isset($user))--}}
{{--                <div class="tab-pane fade" id="prestamo" role="tabpanel" aria-labelledby="prestamos-tab">--}}
{{--                    @include('agentesViews.registroClientes.agenteTabPrestamos')--}}
{{--                </div>--}}
{{--                <div class="tab-pane fade" id="fiadores" role="tabpanel" aria-labelledby="fiadores-tab">--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-md-12">--}}
{{--                            <a href="{{route('agentes.user.fiador.create',['user'=>$user->id_enc])}}" class="btn btn-sm btn-primary">Nuevo Fiador <i class="fa fa-plus"></i> </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <br>--}}
{{--                        @include('agentesViews.registroClientes.agenteTabFiadores')--}}
{{--                </div>--}}
{{--                <div class="tab-pane fade" id="negocios" role="tabpanel" aria-labelledby="negocios-tab">--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-md-12">--}}
{{--                            <a href="{{route('agentes.user.negocios.create',['user'=>$user->id_enc])}}" target="_blank" class="btn btn-sm btn-primary">Nuevo negocio <i class="fa fa-plus"></i> </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <br>--}}
{{--                        @include('agentesViews.registroClientes.agenteTabNegocios')--}}
{{--                </div>--}}
{{--            @endif--}}
