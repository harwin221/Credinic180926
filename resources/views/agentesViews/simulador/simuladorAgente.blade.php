        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" name="montoTotalFinanciar" style="background: lightgray" required
                       class="form-control calcular" id="montoTotalFinanciar" readonly>
            </div>
        </div>
              ...
              if (diasPreferidos !== '' && (diasPreferidos > 31 || diasPreferidos <= 0 || diasPreferidos % 1 > 0)) {
                ...
                for (let i = 0; i <= resPlazo; i++) {
                    if (i === 0) {
                        ...
                        if (formaPago === "3" && !["",0,null,"0"].includes(diasPreferidos) && arrFechasMes.filter(fecha => fecha === mesCopia + "-" + anyoCopia).length > 1) {
