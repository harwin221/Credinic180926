    ...
    <div class="col-md-4 my-auto">
        <div class="row">
            <div class="form-group text-center">
                <img src="{{ isset($user) ? $user->user_image : asset('assets/img/adminFotos/no-photo.jpg')}}" class="img-thumbnail" alt="">
            </div>
        </div>
        <br>
        <div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{html()->select('sucursal_id', ['' => '-- Sin Sucursal --'] + $sucursales)->class(['form-control'])->id('sucursal_id')}}
            </div>
        </div>
        
        <div class="form-group">
            <label for="hora_inicio" class="fw-bold">Hora Inicio Acceso:</label>
            <div class="input-group">
                <span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                {{html()->time('hora_inicio')->class(['form-control'])->id('hora_inicio')->isReadonly(!auth()->user()->can('Modificar Horario de Acceso Admins'))}}
            </div>
        </div>

        <div class="form-group">
            <label for="hora_fin" class="fw-bold">Hora Fin Acceso:</label>
            <div class="input-group">
                <span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                {{html()->time('hora_fin')->class(['form-control'])->id('hora_fin')->isReadonly(!auth()->user()->can('Modificar Horario de Acceso Admins'))}}
            </div>
        </div>
    </div>
</div>
