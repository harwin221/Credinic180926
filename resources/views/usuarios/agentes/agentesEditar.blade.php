...
@section('content')
    @can('Cambiar Contraseña Agentes')
    <div class="row">
        <div class="col-md-12">
    ...
    {{html()->modelForm($user,'POST',route('user.agentes.update',$user->id_enc))->acceptsFiles()->open()}}
    @method('PUT')
    ...
    <br>
        <div class="row justify-content-center">
            <div class="col-md-4">
                <button type="submit" class="btn btn-primary w-100">Actualizar datos del agente <i class="fa fa-save"></i> </button>
            </div>
        </div>
    @endcan
    {{html()->closeModelForm()}}
